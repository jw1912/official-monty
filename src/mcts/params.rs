...
make_mcts_params! {
    ...
    knight_value: f32 = 0.09, 0.02, 0.2, 0.01, 0.002;
    bishop_value: f32 = 0.09, 0.02, 0.2, 0.01, 0.002;
    rook_value: f32 = 0.13, 0.05, 0.3, 0.02, 0.002;
    queen_value: f32 = 0.25, 0.1, 0.4, 0.03, 0.002;
    material_offset: f32 = 1.0, 0.4, 1.2, 0.04, 0.002;
    material_factor: f32 = 0.05, 0.0, 0.2, 0.01, 0.002;
