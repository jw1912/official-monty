...
make_mcts_params! {
    ...
    gini_base: f32 = 0.7, 0.2, 2.0, 0.0679, 0.002;
    gini_offset: f32 = 1.8, 0.2, 2.0, 0.0679, 0.002;
    gini_ln_multiplier: f32 = 1.5, 0.4, 3.0, 0.1634, 0.002;
    gini_min: f32 = 0.9, 0.5, 4.0, 0.21, 0.002;
    gini_max: f32 = 1.5, 0.5, 4.0, 2.21, 0.002;
