...
make_mcts_params! {
    ...
    knight_value: f32 = 0.9, 0.2, 2.0, 0.1, 0.002;
    bishop_value: f32 = 0.9, 0.2, 2.0, 0.1, 0.002;
    rook_value: f32 = 1.3, 0.5, 3.0, 0.2, 0.002;
    queen_value: f32 = 2.5, 1.0, 4.0, 0.3, 0.002;
    material_offset: f32 = 0.95, 0.4, 1.2, 0.04, 0.002;
