...
make_mcts_params! {
    root_pst: f32 = 3.28, 1.0, 10.0, 0.364, 0.002;
    depth_2_pst: f32 = 1.03, 1.0, 10.0, 0.04, 0.002;
    winning_pst_threshold: f32 = 0.425, 0.0, 1.0, 0.07, 0.002;
    winning_pst_max: f32 = 1.158, 0.1, 10.0, 0.15, 0.002;
    root_cpuct: f32 = 0.274, 0.1, 5.0, 0.0314, 0.002;
    cpuct: f32 = 0.243, 0.1, 5.0, 0.0314, 0.002;
    cpuct_var_weight: f32 = 0.7, 0.0, 2.0, 0.0851, 0.002;
    cpuct_var_scale: f32 = 0.242, 0.0, 2.0, 0.0257, 0.002;
    cpuct_visits_scale: f32 = 17.4, 1.0, 512.0, 3.73, 0.002;
    expl_tau: f32 = 0.638, 0.1, 1.0, 0.0623, 0.002;
    gini_base: f32 = 0.658, 0.2, 2.0, 0.0679, 0.002;
    gini_ln_multiplier: f32 = 0.909, 0.4, 3.0, 0.1634, 0.002;
    gini_min: f32 = 1.894, 0.5, 4.0, 0.21, 0.002;
    knight_value: i32 = 637, 250, 750, 45, 0.002;
    bishop_value: i32 = 453, 250, 750, 45, 0.002;
    rook_value: i32 = 786, 400, 1000, 65, 0.002;
    queen_value: i32 = 1483, 900, 1600, 125, 0.002;
    material_offset: i32 = 542, 400, 1200, 70, 0.002;
    material_div1: i32 = 30, 16, 64, 3, 0.002;
    material_div2: i32 = 1095, 512, 1536, 102, 0.002;
